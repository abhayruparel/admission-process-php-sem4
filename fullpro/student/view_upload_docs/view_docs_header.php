...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    ...
    header("location: ../upload_docs/upload_docs_connect.php");
    exit;
}
?>
<!DOCTYPE html>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" style="margin-bottom: 0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part">
                    <a class="logo" href="index.php"><b><img src="../assets/images/maple-icon.png" alt="Home"></b><span class="hidden-xs"><font>Students</font></span></a>
                </div>
        ...
        <div class="navbar-default sidebar nicescroll" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li class="active">
                        <a href="../main/index.php" class="waves-effect">&nbsp;&nbsp;&nbsp; <b>Dashbord</b></a>
                    </li>


                    <li class="active">
                        <a href="../Enquiry_form/enquiry_form.php" class="waves-effect">&nbsp;&nbsp;&nbsp; <b>Enquiry Form</b></a>
                    </li>


                    <li>
                        <a href="../admission_form/enroll_form.php" class="waves-effect">&nbsp;&nbsp;&nbsp; <b>Admission Form</b></a>
                    </li>

                    <li>
                        <a href="../upload_docs/upload_docs.php" class="waves-effect">&nbsp;&nbsp;&nbsp; <b>Upload Documents</b></a>
                    </li>

                    <li>
                        <a href="../view_upload_docs/view_docs.php" class="waves-effect">&nbsp;&nbsp;&nbsp; <b>View Uploaded Documents</b></a>
                    </li>

                    <li>
                        <a href="../Student_query/student_form.php" class="waves-effect">&nbsp;&nbsp;&nbsp; <b>Student Query</b></a>
                    </li>
                </ul>
            </div>
            <!-- /.sidebar-collapse -->
