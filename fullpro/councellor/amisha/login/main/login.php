<?php
    ...
    include("../../db.php");
    session_start();
    //session temporay variable stores in browser
...
if (isset($_POST["btn"]))
{
    ...
    $qry="select * from counsellor_master where couns_mail = '$email' and couns_pass = '$pass';";
    //echo $qry;
    ...
    if ($a_cnt == 1)
    {
        ...
        $_SESSION["couns_id"] = $a_res["couns_id"];
        $_SESSION["login"] = 1;
