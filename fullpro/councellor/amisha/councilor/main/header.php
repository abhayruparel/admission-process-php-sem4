...
else
{
  ...
  $qry="select * from counsellor_master where couns_id='$counselor_id';";
  $c_fire=$conn->query($qry);
  $c_res=$c_fire->fetch_assoc();
  $c_name=$c_res["couns_fname"]." ".$c_res["couns_lname"];
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" style="margin-bottom: 0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part">
                    <a class="logo" href="index.php"><b><img src="../assets/images/maple-icon.png" alt="Home"></b><span class="hidden-xs"><font>Councilor</font></span></a>
                </div>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="../assets/images/users/hritik.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?php echo $c_name; ?></b> </a>
        ...
        <div class="navbar-default sidebar nicescroll" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li>
                        <a href="student.php" class="waves-effect">&nbsp;&nbsp;&nbsp; <b>Your Students</b></a>
                    </li>


                    <li>
                        <a href="status.php" class="waves-effect">&nbsp;&nbsp;&nbsp; <b>Status</b></a>
                    </li>


                     <li>
                        <a href="show_stu_qry.php" class="waves-effect">&nbsp;&nbsp;&nbsp; <b>Queries</b></a>
                    </li>


                    <li>
                        <a href="inbox.php" class="waves-effect">&nbsp;&nbsp;&nbsp; <b>Mails</b></a>
                    </li>
