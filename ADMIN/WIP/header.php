    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar nicescroll" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li class="active">
                        <a href="display_admin/display_counsellor_alloted.php" class="waves-effect">&nbsp;&nbsp;&nbsp; <b>Display counsellor alloted</b></a>
                    </li>


                    <li>
                        <a href="display_admin/display_students_enquiry.php" class="waves-effect">&nbsp;&nbsp;&nbsp; <b>Display Students inquiry</b></a>
                    </li>

                    <li>
                        <a href="display_admin/display_consellor.php" class="waves-effect">&nbsp;&nbsp;&nbsp; <b>Display counsellor</b></a>
                    </li>
