...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM signup_data WHERE mail = ?";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO signup_data (name,mail, passwd) VALUES (?,?, ?)";
...
<body>
    <div   class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="form" method="post">
            ...
            <b><p>Already have an account? <a class="login"  href="login.php">Login here</a>.</p></b>
        </form>
    </div>    
</body>
</html>